...
$sql_2 = "SELECT * FROM `tb_mesaatendimento` WHERE `tb_mesaatendimento`.`ma_ID` = '$id' ORDER BY `tb_mesaatendimento`.`ma_ID` ASC";
...
$submit_2->execute();
if ($submit_2->rowCount() > 0) {	$s_ = $submit_2->fetchAll(\PDO::FETCH_ASSOC); }
